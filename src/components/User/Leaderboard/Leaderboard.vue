                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <router-link :to="{name: 'view-profile', params: {id: this.rank[1].detail_user.id, email: this.rank[1].detail_user.email}}">
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user">
                                <!-- Add the bg color to the header using any of the bg-* classes -->
                                <div class="widget-user-header bg-gradient-lime">
                                    <h3 class="widget-user-username text-center">RANK 1</h3>
                                    <h5 class="widget-user-desc text-center">{{ this.rank[0].detail_user.name }}</h5>
                                </div>
                                <div class="widget-user-image">
                                     <router-link :to="{name: 'view-profile', params: {id: this.rank[0].detail_user.id, email: this.rank[0].detail_user.email}}">
                        ...
                        <div class="col-md-4">
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <router-link :to="{name: 'view-profile', params: {id: this.rank[2].detail_user.id, email: this.rank[2].detail_user.email}}">

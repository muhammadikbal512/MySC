                   ...
                   <div class="col-md-12">
                    ...
                    <form @submit.prevent="Submit">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" placeholder="Ex : iqbal@raharja.info" v-model="email">
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" placeholder="Ex : Muhammad Iqbal" v-model="name">
                        </div>
                        <div class="form-group">
                            <label>Team</label>
                            <input type="text" class="form-control" placeholder="Ex : Blueberry" v-model="team">
                        </div>
                        <button type="submit" class="btn btn-class" style="color:white; background-color:teal;">Submit</button>
